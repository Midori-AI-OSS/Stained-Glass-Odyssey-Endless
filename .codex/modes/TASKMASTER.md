...
- When drafting relic, card, or passive work, do not require contributors to update roll-up docs. The plugin modules already host the canonical descriptions, so keeping those files current is sufficient.
