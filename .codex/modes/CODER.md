...
- **MANDATORY**: When a task is finished, always append `ready for review` at the bottom of the task file or PR description so reviewers know the work is complete.
