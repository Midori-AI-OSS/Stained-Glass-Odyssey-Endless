# Passive Tasks - Task Master Review

Passive ability implementation tasks in this folder have been audited and are awaiting final Task Master sign-off.

## Folder Organization

This folder contains tier-specific subfolders for organizing passive implementation tasks:
...
Each subfolder has its own AGENTS.md file explaining the context and purpose of that specific tier. Passive modifiers (boss, glitched, prime) are encounter-based tags applied by the foe factory and layer on top of base character implementations.
