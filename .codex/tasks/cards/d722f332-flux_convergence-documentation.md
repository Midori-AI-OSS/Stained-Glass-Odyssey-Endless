# Add Documentation Fields to Flux Convergence Card

## Objective

Add `full_about` and `summarized_about` fields to the Flux Convergence card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/flux_convergence.py`
...
```python
@dataclass
class FluxConvergenceCard(CardBase):
