# Add Documentation Fields to Oracle Prayer Charm Card

## Objective

Add `full_about` and `summarized_about` fields to the Oracle Prayer Charm card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/oracle_prayer_charm.py`
...
```python
@dataclass
class OraclePrayerCharmCard(CardBase):
