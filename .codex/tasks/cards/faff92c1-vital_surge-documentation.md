# Add Documentation Fields to Vital Surge Card

## Objective

Add `full_about` and `summarized_about` fields to the Vital Surge card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/vital_surge.py`
