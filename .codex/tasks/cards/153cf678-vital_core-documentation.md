# Add Documentation Fields to Vital Core Card

## Objective

Add `full_about` and `summarized_about` fields to the Vital Core card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/vital_core.py`
