# Add Documentation Fields to Phantom Ally Card

## Objective

Add `full_about` and `summarized_about` fields to the Phantom Ally card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/phantom_ally.py`
...
```python
@dataclass
class PhantomAllyCard(CardBase):
    id: str = "phantom_ally"
