# Add Documentation Fields to Guardian Shard Card

## Objective

Add `full_about` and `summarized_about` fields to the Guardian Shard card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/guardian_shard.py`
...
```python
@dataclass
class GuardianShardCard(CardBase):
