# Add Documentation Fields to Adamantine Band Card

## Objective

Add `full_about` and `summarized_about` fields to the Adamantine Band card plugin to support enhanced documentation and future AI integration.
...
```python
@dataclass
class AdamantineBandCard(CardBase):
