# Add Documentation Fields to Keen Goggles Card

## Objective

Add `full_about` and `summarized_about` fields to the Keen Goggles card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/keen_goggles.py`
...
```python
@dataclass
class KeenGogglesCard(CardBase):
    id: str = "keen_goggles"
