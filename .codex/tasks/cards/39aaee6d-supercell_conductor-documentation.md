# Add Documentation Fields to Supercell Conductor Card

## Objective

Add `full_about` and `summarized_about` fields to the Supercell Conductor card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/supercell_conductor.py`
...
```python
@dataclass
class SupercellConductorCard(CardBase):
