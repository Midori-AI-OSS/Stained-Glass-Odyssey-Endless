# Add Documentation Fields to Coated Armor Card

## Objective

Add `full_about` and `summarized_about` fields to the Coated Armor card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/coated_armor.py`
...
```python
@dataclass
class CoatedArmorCard(CardBase):
    id: str = "coated_armor"
