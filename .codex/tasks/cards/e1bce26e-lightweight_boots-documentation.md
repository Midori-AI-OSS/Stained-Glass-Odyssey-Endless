# Add Documentation Fields to Lightweight Boots Card

## Objective

Add `full_about` and `summarized_about` fields to the Lightweight Boots card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/lightweight_boots.py`
...
```python
@dataclass
class LightweightBootsCard(CardBase):
