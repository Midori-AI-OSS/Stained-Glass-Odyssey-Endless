# Add Documentation Fields to Bulwark Totem Card

## Objective

Add `full_about` and `summarized_about` fields to the Bulwark Totem card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/bulwark_totem.py`
...
```python
@dataclass
class BulwarkTotemCard(CardBase):
