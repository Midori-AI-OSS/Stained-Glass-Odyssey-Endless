# Add Documentation Fields to Sturdy Vest Card

## Objective

Add `full_about` and `summarized_about` fields to the Sturdy Vest card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/sturdy_vest.py`
