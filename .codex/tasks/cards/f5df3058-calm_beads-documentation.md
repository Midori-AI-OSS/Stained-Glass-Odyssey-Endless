# Add Documentation Fields to Calm Beads Card

## Objective

Add `full_about` and `summarized_about` fields to the Calm Beads card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/calm_beads.py`
