# Add Documentation Fields to Swift Footwork Card

## Objective

Add `full_about` and `summarized_about` fields to the Swift Footwork card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/swift_footwork.py`
...
```python
@dataclass
class SwiftFootworkCard(CardBase):
