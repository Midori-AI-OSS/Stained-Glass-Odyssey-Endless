# Add Documentation Fields to Energizing Tea Card

## Objective

Add `full_about` and `summarized_about` fields to the Energizing Tea card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/energizing_tea.py`
...
```python
@dataclass
class EnergizingTeaCard(CardBase):
