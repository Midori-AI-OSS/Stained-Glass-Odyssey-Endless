# Add Documentation Fields to Battle Meditation Card

## Objective

Add `full_about` and `summarized_about` fields to the Battle Meditation card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/battle_meditation.py`
...
```python
@dataclass
class BattleMeditationCard(CardBase):
