# Add Documentation Fields to Spiked Shield Card

## Objective

Add `full_about` and `summarized_about` fields to the Spiked Shield card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/spiked_shield.py`
...
```python
@dataclass
class SpikedShieldCard(CardBase):
