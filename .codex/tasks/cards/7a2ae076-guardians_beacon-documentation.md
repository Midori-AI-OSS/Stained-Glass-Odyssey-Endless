# Add Documentation Fields to Guardians Beacon Card

## Objective

Add `full_about` and `summarized_about` fields to the Guardians Beacon card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/guardians_beacon.py`
...
```python
@dataclass
class GuardiansBeaconCard(CardBase):
    id: str = "guardians_beacon"
    name: str = "Guardians Beacon"
    # ... existing fields ...
