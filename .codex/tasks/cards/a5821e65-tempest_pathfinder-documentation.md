# Add Documentation Fields to Tempest Pathfinder Card

## Objective

Add `full_about` and `summarized_about` fields to the Tempest Pathfinder card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/tempest_pathfinder.py`
...
```python
@dataclass
class TempestPathfinderCard(CardBase):
