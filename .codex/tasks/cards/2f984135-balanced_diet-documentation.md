# Add Documentation Fields to Balanced Diet Card

## Objective

Add `full_about` and `summarized_about` fields to the Balanced Diet card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/balanced_diet.py`
...
```python
@dataclass
class BalancedDietCard(CardBase):
