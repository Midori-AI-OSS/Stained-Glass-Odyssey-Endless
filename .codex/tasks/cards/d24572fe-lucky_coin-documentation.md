# Add Documentation Fields to Lucky Coin Card

## Objective

Add `full_about` and `summarized_about` fields to the Lucky Coin card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/lucky_coin.py`
