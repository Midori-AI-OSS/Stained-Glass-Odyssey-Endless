# Add Documentation Fields to Critical Focus Card

## Objective

Add `full_about` and `summarized_about` fields to the Critical Focus card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/critical_focus.py`
...
```python
@dataclass
class CriticalFocusCard(CardBase):
