# Add Documentation Fields to Fortified Plating Card

## Objective

Add `full_about` and `summarized_about` fields to the Fortified Plating card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/fortified_plating.py`
...
```python
@dataclass
class FortifiedPlatingCard(CardBase):
