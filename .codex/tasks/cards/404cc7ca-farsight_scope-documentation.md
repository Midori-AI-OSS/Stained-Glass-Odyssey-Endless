# Add Documentation Fields to Farsight Scope Card

## Objective

Add `full_about` and `summarized_about` fields to the Farsight Scope card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/farsight_scope.py`
...
```python
@dataclass
class FarsightScopeCard(CardBase):
