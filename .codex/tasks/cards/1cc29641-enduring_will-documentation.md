# Add Documentation Fields to Enduring Will Card

## Objective

Add `full_about` and `summarized_about` fields to the Enduring Will card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/enduring_will.py`
...
```python
@dataclass
class EnduringWillCard(CardBase):
