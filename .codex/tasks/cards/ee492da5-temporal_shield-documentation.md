# Add Documentation Fields to Temporal Shield Card

## Objective

Add `full_about` and `summarized_about` fields to the Temporal Shield card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/temporal_shield.py`
...
```python
@dataclass
class TemporalShieldCard(CardBase):
