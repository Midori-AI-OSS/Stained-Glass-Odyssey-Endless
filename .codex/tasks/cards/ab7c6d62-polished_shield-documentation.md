# Add Documentation Fields to Polished Shield Card

## Objective

Add `full_about` and `summarized_about` fields to the Polished Shield card plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/cards/polished_shield.py`
...
```python
@dataclass
class PolishedShieldCard(CardBase):
