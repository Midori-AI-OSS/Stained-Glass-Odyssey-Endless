# Add Documentation Fields to Fallback Essence Relic

## Objective

Add `full_about` and `summarized_about` fields to the Fallback Essence relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/fallback_essence.py`
...
```python
@dataclass
class FallbackEssenceRelic(RelicBase):
    id: str = "fallback_essence"
    name: str = "Fallback Essence"
    # ... existing fields ...
