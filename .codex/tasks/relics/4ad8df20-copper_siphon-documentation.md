# Add Documentation Fields to Copper Siphon Relic

## Objective

Add `full_about` and `summarized_about` fields to the Copper Siphon relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/copper_siphon.py`
...
```python
@dataclass
class CopperSiphonRelic(RelicBase):
