# Add Documentation Fields to Field Rations Relic

## Objective

Add `full_about` and `summarized_about` fields to the Field Rations relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/field_rations.py`
...
```python
@dataclass
class FieldRationsRelic(RelicBase):
