# Add Documentation Fields to Old Coin Relic

## Objective

Add `full_about` and `summarized_about` fields to the Old Coin relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/old_coin.py`
...
- [x] Added `full_about_stacks()` method to provide stack-specific descriptions
