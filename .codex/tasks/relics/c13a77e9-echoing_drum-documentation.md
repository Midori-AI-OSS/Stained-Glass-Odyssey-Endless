# Add Documentation Fields to Echoing Drum Relic

## Objective

Add `full_about` and `summarized_about` fields to the Echoing Drum relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/echoing_drum.py`
...
```python
@dataclass
class EchoingDrumRelic(RelicBase):
    id: str = "echoing_drum"
