# Add Documentation Fields to Catalyst Vials Relic

## Objective

Add `full_about` and `summarized_about` fields to the Catalyst Vials relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/catalyst_vials.py`
...
```python
@dataclass
class CatalystVialsRelic(RelicBase):
