# Add Documentation Fields to Null Lantern Relic

## Objective

Add `full_about` and `summarized_about` fields to the Null Lantern relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/null_lantern.py`
...
```python
@dataclass
class NullLanternRelic(RelicBase):
    id: str = "null_lantern"
