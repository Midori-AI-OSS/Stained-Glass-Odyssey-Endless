# Add Documentation Fields to Arcane Flask Relic

## Objective

Add `full_about` and `summarized_about` fields to the Arcane Flask relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/arcane_flask.py`
...
```python
@dataclass
class ArcaneFlaskRelic(RelicBase):
    id: str = "arcane_flask"
