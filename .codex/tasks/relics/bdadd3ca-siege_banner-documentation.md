# Add Documentation Fields to Siege Banner Relic

## Objective

Add `full_about` and `summarized_about` fields to the Siege Banner relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/siege_banner.py`
...
```python
@dataclass
class SiegeBannerRelic(RelicBase):
    id: str = "siege_banner"
