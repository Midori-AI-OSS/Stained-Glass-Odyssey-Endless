...
**Reviewed:** backend/plugins/relics/cataclysm_engine.py

**Findings:**
- ✅ Old `about` field: Removed
- ✅ `full_about`: Present with detailed mechanics including '15% HP sacrifice', '250% core stats', '5% HP drains'
- ✅ `summarized_about`: Present with qualitative description ('Trades HP for overwhelming tempo; detonates at battle start...')
- ✅ Format compliance: `full_about` includes specific percentages, `summarized_about` is qualitative
- ✅ Accuracy: Descriptions match complex legendary relic mechanics with escalating effects
