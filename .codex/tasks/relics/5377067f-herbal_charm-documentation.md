# Add Documentation Fields to Herbal Charm Relic

## Objective

Add `full_about` and `summarized_about` fields to the Herbal Charm relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/herbal_charm.py`
...
```python
@dataclass
class HerbalCharmRelic(RelicBase):
    id: str = "herbal_charm"
