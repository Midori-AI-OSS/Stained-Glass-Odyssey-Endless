# Add Documentation Fields to Shiny Pebble Relic

## Objective

Add `full_about` and `summarized_about` fields to the Shiny Pebble relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/shiny_pebble.py`
...
```python
@dataclass
class ShinyPebbleRelic(RelicBase):
    id: str = "shiny_pebble"
