# Add Documentation Fields to Entropy Mirror Relic

## Objective

Add `full_about` and `summarized_about` fields to the Entropy Mirror relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/entropy_mirror.py`
...
```python
@dataclass
class EntropyMirrorRelic(RelicBase):
