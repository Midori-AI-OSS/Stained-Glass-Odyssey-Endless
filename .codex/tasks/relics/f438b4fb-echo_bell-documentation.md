# Add Documentation Fields to Echo Bell Relic

## Objective

Add `full_about` and `summarized_about` fields to the Echo Bell relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/echo_bell.py`
...
- [x] Added `full_about_stacks()` method for consistency
