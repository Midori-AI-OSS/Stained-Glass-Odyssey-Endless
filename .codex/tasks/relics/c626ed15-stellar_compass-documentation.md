# Add Documentation Fields to Stellar Compass Relic

## Objective

Add `full_about` and `summarized_about` fields to the Stellar Compass relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/stellar_compass.py`
...
```python
@dataclass
class StellarCompassRelic(RelicBase):
