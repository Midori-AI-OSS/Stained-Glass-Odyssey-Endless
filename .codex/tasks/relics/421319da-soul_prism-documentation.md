# Add Documentation Fields to Soul Prism Relic

## Objective

Add `full_about` and `summarized_about` fields to the Soul Prism relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/soul_prism.py`
...
```python
@dataclass
class SoulPrismRelic(RelicBase):
    id: str = "soul_prism"
    name: str = "Soul Prism"
    # ... existing fields ...
