# Add Documentation Fields to Frost Sigil Relic

## Objective

Add `full_about` and `summarized_about` fields to the Frost Sigil relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/frost_sigil.py`
...
```python
@dataclass
class FrostSigilRelic(RelicBase):
    id: str = "frost_sigil"
