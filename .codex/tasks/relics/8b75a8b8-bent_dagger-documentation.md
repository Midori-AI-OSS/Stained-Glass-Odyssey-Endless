# Add Documentation Fields to Bent Dagger Relic

## Objective

Add `full_about` and `summarized_about` fields to the Bent Dagger relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/bent_dagger.py`
...
```python
@dataclass
class BentDaggerRelic(RelicBase):
    id: str = "bent_dagger"
