# Add Documentation Fields to Threadbare Cloak Relic

## Objective

Add `full_about` and `summarized_about` fields to the Threadbare Cloak relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/threadbare_cloak.py`
...
```python
@dataclass
class ThreadbareCloakRelic(RelicBase):
