# Add Documentation Fields to Graviton Locket Relic

## Objective

Add `full_about` and `summarized_about` fields to the Graviton Locket relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/graviton_locket.py`
...
```python
@dataclass
class GravitonLocketRelic(RelicBase):
