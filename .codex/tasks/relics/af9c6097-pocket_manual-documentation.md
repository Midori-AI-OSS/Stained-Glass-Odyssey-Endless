# Add Documentation Fields to Pocket Manual Relic

## Objective

Add `full_about` and `summarized_about` fields to the Pocket Manual relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/pocket_manual.py`
...
```python
@dataclass
class PocketManualRelic(RelicBase):
