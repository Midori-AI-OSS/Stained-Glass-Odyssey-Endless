# Add Documentation Fields to Lucky Button Relic

## Objective

Add `full_about` and `summarized_about` fields to the Lucky Button relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/lucky_button.py`
...
```python
@dataclass
class LuckyButtonRelic(RelicBase):
    id: str = "lucky_button"
