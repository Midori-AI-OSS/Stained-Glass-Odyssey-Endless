# Add Documentation Fields to Paradox Hourglass Relic

## Objective

Add `full_about` and `summarized_about` fields to the Paradox Hourglass relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/paradox_hourglass.py`
...
```python
@dataclass
class ParadoxHourglassRelic(RelicBase):
