# Add Documentation Fields to Ember Stone Relic

## Objective

Add `full_about` and `summarized_about` fields to the Ember Stone relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/ember_stone.py`
...
```python
@dataclass
class EmberStoneRelic(RelicBase):
    id: str = "ember_stone"
