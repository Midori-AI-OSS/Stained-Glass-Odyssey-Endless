# Add Documentation Fields to Guardian Charm Relic

## Objective

Add `full_about` and `summarized_about` fields to the Guardian Charm relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/guardian_charm.py`
...
```python
@dataclass
class GuardianCharmRelic(RelicBase):
