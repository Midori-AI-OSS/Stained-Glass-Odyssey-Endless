# Add Documentation Fields to Plague Harp Relic

## Objective

Add `full_about` and `summarized_about` fields to the Plague Harp relic plugin to support enhanced documentation and future AI integration.
...
**File to modify:** `backend/plugins/relics/plague_harp.py`
...
```python
@dataclass
class PlagueHarpRelic(RelicBase):
    id: str = "plague_harp"
