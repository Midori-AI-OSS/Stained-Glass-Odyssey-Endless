# Migrate Lady Light Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Light character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_light.py`
...
Completed: Character migration successful. Summary: "An Aasimar battling Cotard's Syndrome who creates protective light barriers to affirm existence against the void she perceives within."
