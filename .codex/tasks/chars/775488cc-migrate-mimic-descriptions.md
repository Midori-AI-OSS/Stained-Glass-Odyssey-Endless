# Migrate Mimic Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Mimic character class to support concise/verbose description modes in the frontend.
