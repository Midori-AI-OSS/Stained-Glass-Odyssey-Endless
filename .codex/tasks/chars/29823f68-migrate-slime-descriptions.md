# Migrate Slime Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Slime character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/slime.py`
