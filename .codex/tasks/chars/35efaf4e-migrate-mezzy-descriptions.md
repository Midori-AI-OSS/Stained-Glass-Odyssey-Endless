# Migrate Mezzy Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Mezzy character class to support concise/verbose description modes in the frontend.
...
Completed: Character migration successful. Summary: "A voracious defender who devours enemy attacks and converts them into power, growing stronger with every blow."
