# Migrate Carly Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Carly character class to support concise/verbose description modes in the frontend.
