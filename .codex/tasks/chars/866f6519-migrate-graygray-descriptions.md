# Migrate GrayGray Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the GrayGray character class to support concise/verbose description modes in the frontend.
