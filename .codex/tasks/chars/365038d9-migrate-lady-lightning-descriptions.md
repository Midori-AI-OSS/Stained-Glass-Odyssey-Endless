# Migrate Lady Lightning Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Lightning character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_lightning.py`
...
Completed: Character migration successful. Summary: "Lady Wind's storm-tossed twin who escaped a lab and now channels lightning with manic intensity, unable to distinguish guidance from delusion."
