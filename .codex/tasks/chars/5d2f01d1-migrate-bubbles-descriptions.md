# Migrate Bubbles Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Bubbles character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/bubbles.py`
...
Completed: Character migration successful. Summary: "An enthusiastic aquatic fighter who creates cascading bubble explosions, turning playful attacks into devastating chain reactions."
