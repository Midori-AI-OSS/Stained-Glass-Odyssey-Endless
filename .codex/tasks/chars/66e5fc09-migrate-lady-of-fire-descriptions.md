# Migrate Lady of Fire Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady of Fire character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_of_fire.py`
