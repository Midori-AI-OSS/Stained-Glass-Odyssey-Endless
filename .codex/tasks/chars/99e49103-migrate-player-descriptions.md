# Migrate Player Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Player character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/player.py`
...
**Note:** The Player is the main customizable character, so the summary should be general enough to fit any player configuration.
