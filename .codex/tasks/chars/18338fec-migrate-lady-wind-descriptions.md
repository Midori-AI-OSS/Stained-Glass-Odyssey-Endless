# Migrate Lady Wind Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Wind character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_wind.py`
...
Completed: Character migration successful. Summary: "Lady Lightning's twin sister, an Aasimar aeromancer cloaked in bleeding winds who guards allies with precision despite her chaotic experiments."
