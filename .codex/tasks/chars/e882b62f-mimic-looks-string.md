# Add Looks String to Mimic Character

## Description
Add a `looks` field to the Mimic character class (`backend/plugins/characters/mimic.py`) following the format used in Luna, Ryne, Lady Light, and Lady Darkness.
...
**User must provide:** Detailed visual description of Mimic's appearance, including:
...
## Acceptance Criteria
- [ ] `looks` field added to the Mimic dataclass
