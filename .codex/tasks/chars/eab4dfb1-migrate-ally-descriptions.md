# Migrate Ally Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Ally character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/ally.py`
