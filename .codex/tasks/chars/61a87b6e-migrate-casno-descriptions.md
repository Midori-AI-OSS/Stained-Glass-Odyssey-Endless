# Migrate Casno Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Casno character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/casno.py`
