# Migrate Lady Storm Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Storm character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_storm.py`
...
Completed: Character migration successful. Summary: "An aasimar tempest caller who bends storms into weapons, capable of gentle tailwinds or catastrophic derechos."
