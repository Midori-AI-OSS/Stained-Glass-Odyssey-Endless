# Migrate Lady Fire and Ice Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Fire and Ice character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_fire_and_ice.py`
...
Completed: Character migration successful. Summary: "A dual-natured elemental master who switches between volcanic fury and arctic precision, creating devastating thermal shocks."
