# Migrate Hilander Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Hilander character class to support concise/verbose description modes in the frontend.
