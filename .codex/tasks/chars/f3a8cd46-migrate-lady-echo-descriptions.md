# Migrate Lady Echo Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Echo character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_echo.py`
