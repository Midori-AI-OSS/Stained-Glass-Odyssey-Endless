# Migrate Lady Darkness Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Lady Darkness character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/lady_darkness.py`
