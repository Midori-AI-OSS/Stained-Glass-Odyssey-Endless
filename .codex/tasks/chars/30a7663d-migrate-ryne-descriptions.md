# Migrate Ryne Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Ryne character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/ryne.py`
...
Completed: Character migration successful. Summary: "An Oracle of Light who leads restoration missions with calm resolve, channeling light through twin blades with agile precision."
