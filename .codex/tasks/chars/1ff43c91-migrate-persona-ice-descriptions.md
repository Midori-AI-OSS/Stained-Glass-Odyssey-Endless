# Migrate Persona Ice Character Descriptions

## Objective

Add `full_about` and `summarized_about` fields to the Persona Ice character class to support concise/verbose description modes in the frontend.
...
`backend/plugins/characters/persona_ice.py`
...
Completed: Character migration successful. Summary: "A disciplined cryokinetic tank who shields his sisters with protective frost that hardens against blows and heals allies."
