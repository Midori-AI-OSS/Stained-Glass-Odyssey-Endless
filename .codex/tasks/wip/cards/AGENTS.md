# Card Tasks - Work In Progress

Tasks in this folder focus on card implementation and are currently being developed.
...
Documentation reminder: card plugins already document star rank, effects, and triggers. Avoid adding task requirements to update `.codex/implementation/relic-system.md` or other roll-up docs; keep the plugin files up to date instead.
