...
| Ryne | B | 6★ | Light | `ryne_oracle_of_balance` banks balance points off actions, sword hits, and ultimates; every surge layers Light-ward auras on herself, pulses mitigation and healing to Luna and allies, and keeps their link refreshed through the battle. Balance stacks build past 120 at half speed for marathon fights. | 6★ gacha headliner. |
