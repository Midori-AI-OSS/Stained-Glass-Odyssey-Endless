...
<div class="settings-panel">
  ...
  <div class="control" title="Legacy reduced motion setting (use UI tab controls).">
    <div class="control-left">
      <span class="label"><Move /> Reduced Motion</span>
    </div>
    <div class="control-right">
      <input type="checkbox" bind:checked={reducedMotion} disabled />
      <span class="value">Use UI tab controls</span>
    </div>
  </div>
